...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">User's Data</h1>
        <button type="button" class="btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#tambah"><i
                class="fas fa-database fa-sm text-white-50"></i> Add Users</button>
    </div>
            ...
            @foreach ($user as $a)
                <tbody>
                    ...
                    <td>
                        ...
                        @else
                            <img src="{{ Storage::url('public/users/' . $a->gambar) }}" width="100"
    ...
    @foreach ($user as $a)
        <div class="modal fade" id="hapus{{ $a->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Delete User {{ $a->username }}</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="/hapususer" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $a->id }}">
                        <input type="hidden" name="foto" value="{{ $a->gambar }}">
