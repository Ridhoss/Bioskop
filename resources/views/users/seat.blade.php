        ...
        <div class="seat-pick">
            ...
            <div class="info">
                ...
                <div class="desc-info">
                    ...
                    <p id="note">*Maximum 4 seats in 1 order/account</p>
                </div>
...
<script>
    ...
    document.querySelectorAll('.seat-pick input[type="checkbox"]').forEach(checkbox => {
      checkbox.addEventListener('change', () => {
        ...
        // Update the selectedSeats object to reflect the selection
        if (isSeatAvailable) {
        ...
        document.getElementById('ttl-hrga').textContent = 'Total Harga : Rp. ' + totalCost.toLocaleString('id-ID');
      });
    });
  </script>
